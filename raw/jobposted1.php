...
// 				$closed=$row[9];
		...
		<div style="border: 1px">
			<div class="col-lg-9" style="margin-top: 7px;">
			      ...
			      <a href="#"><h4><?php echo $row[7]; ?></h4></a>
			      <div><b>Location: </b><?php echo $row[2]; ?></div>
			      <div style="margin-left: 30%; margin-top: -3%"><b>Experience: </b><?php echo $row[3]; ?></div>
			      <div style="margin-left: 60%; margin-top: -3%"><b>Salary: </b><?php echo $row[4]; ?></div>
			      
			      <div style="margin-left: 0%; margin-top: 1%"><b>Posted On: </b><?php echo $row[8]; ?></div>
			      <div style="margin-left: 30%; margin-top: -3%"><b>Application Deadline: </b><?php echo $row[9]; ?></div>
			</div>
			<div class="col-lg-9" style="margin-top: 1%;">
			      <b>Job Description: </b><?php echo $row[5]; ?>
			</div>
			
			<div class="col-lg-9" style="margin-top: 1%;">
			      <b>Skills Required: </b><?php echo $row[6]; ?>
			</div>
		</div>
